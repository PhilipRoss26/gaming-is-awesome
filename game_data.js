const games = [
  {
    ...
    dev: "Nintendo",
    genre: "Adventure",
    whyFav: "Great story and captivating gameplay, beutiful graphics",
    img: "link.jpg"
  },
  {
    ...
    dev: "Rare Ware",
    genre: "Platformer",
    whyFav: "Nostalgic and challenging levels, excellent music",
    img: "kong.jpg"
  },
  {
    name: "Kirby Air Ride",
    dev: "HAL Laboratory",
    genre: "Racing",
    whyFav: "Unique mechanics and extremley fun multiplayer",
    img: "kirb.jpg"
  },
  {
    name: "Mario Kart DS",
    dev: "Nintendo",
    genre: "Racing",
    whyFav: "Some of the best Mario Kart fun AND on the go",
    img: "kart.jpg"
  },
  {
...
const setUpGameCards = () => {
  ...
  games.forEach((game, index) => {
    const cardMarkup = `<div class="card" data-index="${index}">
